...
using Gamer.Component.Engine.GameBoard.Factory;
using Gamer.Component.Engine.GamePlay.Factory;
using Gamer.Component.Engine.GamePlay.Helpers;
...
namespace Gamer.Component.Engine.GamePlay
{
    ...
    public class GamePlayEngine : IGamePlayEngine
    {
        ...
        public async Task<bool> PlayTurn(Guid gameSessionId, Guid playerId, string address)
        {
            ...
            address.NotNullOrWhiteSpace(nameof(address));
