...
namespace TicTacToe.Engine.GamePlay
{

	public class GamePlayEngine
	{

		private readonly BoardEngine board;

		public GamePlayEngine(BoardEngine boardEngine)
		{
		...
		private bool IsWinningVector(params Tile[] vectors)
		{
